...
ibenchmark( [(Arg1,XPos) | BCH_LIST] , Pred , Method , NumTimes , _ , [ (XPos,Med) | RTimes ] ) :-
	T =.. [Pred,Arg1],
	term_to_meta( T , MT ) ,
...
time_of_bench_ntimes( P , Arg1 , Times , [Time] ) :-
	statistics( runtime , [Start , _ ] ),
	bench_ntimes( P , Arg1 , Times ),
	statistics( runtime , [End , _ ] ),
	Time is (End - Start)/Times.
