...
% 
%FILEPATHS = /home/isabel/chartlib
%FILEPATHS = /usr/isa/pruebas
%FILEPATHS = /usr/local/lib/ciao/ciao-1.4/library/chartlib
filepath := ~atom_concat( [ ~ciaosrc , '/contrib/chartlib' ] ).
% ----------------------------------------------------------------------------
...
%SYSTEMPATHS = /usr/local/lib/ciao/ciao-1.4/lib \
%	      /usr/local/lib/ciao/ciao-1.4/library
% ----------------------------------------------------------------------------
...
%
fileoption(~mainfile) := '-nosysmods' | '-noengmods' | '-norefs'.
% ----------------------------------------------------------------------------
...
% for sublibraries) 
% 
component := 'genbar1' | 'genbar2' | 'genbar3' | 'genbar4' | 'genmultibar'|
    'gengraph1' | 'gengraph2' | 'table_widget1' | 'table_widget2' | 'table_widget3'|
    'table_widget4' | 'color_pattern' | 'test_format' | 'chartlib_errhandle'|
    'bltclass'.
% ----------------------------------------------------------------------------
...
% Leaving this blank produces most verbose manuals
% 
fileoption(~component) := '-nosysmods' | '-noengmods' | '-norefs'.
% ----------------------------------------------------------------------------
...
% all
% 
%INDICES=concept pred prop regtype modedef global
...
%DOCDIR=/usr/isa/pruebas/doc
%DOCDIR=/usr/local/lib/ciao/ciao-1.4/library/chartlib/doc
docdir := ~atom_concat( [ ~ciaosrc , '/contrib/chartlib/doc' ] ).
% ----------------------------------------------------------------------------
...
% 
htmlindex_headfile := ~atom_concat( [ ~lpdoclib , '/Indexhead.html' ] ).
% HTMLINDEXHEADFILE = $(LIBDIR)/Head_clip.html
htmlindex_tailfile := ~atom_concat( [ ~lpdoclib , '/Indextail.html' ] ).
...
%
infodir_headfile := ~atom_concat( [ ~lpdoclib , '/Indexhead.info' ] ).
infodir_tailfile := ~atom_concat( [ ~lpdoclib , '/Indextail.info' ] ).
% ----------------------------------------------------------------------------
% end of SETTINGS
