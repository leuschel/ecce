...
% 
filepath := ~atom_concat( [ ~ciaosrc , '/library/make' ] )|
    ~atom_concat( [ ~ciaosrc , '/library/make/example_simple' ] )|
    ~atom_concat( [ ~ciaosrc , '/library/make/example_latex' ] )|
    ~atom_concat( [ ~ciaosrc , '/library/make/LPMAKE' ] ).
% ----------------------------------------------------------------------------
...
% 
systempath := ~atom_concat( [ ~ciaosrc , '/doc/common' ] )|
    ~atom_concat( [ ~ciaosrc , '/lib' ] )|
...
% for sublibraries) 
% 
component := 'make_doc' | 'make_rt' | 'system_extra'.
% ----------------------------------------------------------------------------
