...
% 
filepath := ~atom_concat( [ ~ciaosrc , '/library/pillow' ] )|
    ~atom_concat( [ ~ciaosrc , '/library/pillow/dist/doc' ] ).
% ----------------------------------------------------------------------------
...
%
fileoption(~mainfile) := '-nochangelog' | '-nosysmods' | '-noengmods'.
% ----------------------------------------------------------------------------
...
docformat := 'texi' | 'ps' | 'info' | 'infoindex' | 'html' | 'htmlindex'.
% ----------------------------------------------------------------------------
...
htmlindex_headfile := 'Indexhead_pillow_doc.html'.
% HTMLINDEXTAILFILE = $(LIBDIR)/Indextail.html
htmlindex_tailfile := 'Indextail_pillow_doc.html'.
% ----------------------------------------------------------------------------
