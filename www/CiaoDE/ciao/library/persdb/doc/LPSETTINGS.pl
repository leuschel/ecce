...
% 
filepath := ~atom_concat( [ ~ciaosrc , '/library/persdb' ] )|
    ~atom_concat( [ ~ciaosrc , '/library/persdb/examples' ] )|
...
systempath := ~atom_concat( [ ~ciaosrc , '/lib' ] )|
    ...
    ~atom_concat( [ ~ciaosrc , '/library/engine' ] ).
% ----------------------------------------------------------------------------
...
% -nobullet 
%
fileoption(~mainfile) := '-v' | '-nobugs' | '-modes' | '-nochangelog'.
% ----------------------------------------------------------------------------
...
% Leaving this blank produces most verbose manuals
% 
fileoption(~component) := '-v' | '-nobugs' | '-modes' | '-nochangelog' | '-noversion' | '-noauthors'.
% ----------------------------------------------------------------------------
...
% 
docformat := 'dvi' | 'ps' | 'info' | 'infoindex' | 'html' | 'htmlindex'.
% ----------------------------------------------------------------------------
...
% all
% 
index := 'concept' | 'pred' | 'regtype' | 'usage'.
% ----------------------------------------------------------------------------
