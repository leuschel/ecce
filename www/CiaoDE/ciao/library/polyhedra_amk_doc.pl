...
:- module(polyhedra_amk_doc, [project/3, convex_hull/6, polyhedra_widen/5],[assertions]).

:- comment(title,"Polyhedra library based on CLP(Q) and CLP(R)").

:- comment(author,"Florence Benoy, Andy King and Fred Mesnard").
:- comment(author,"Samir Genaim (porting to Ciao)").
