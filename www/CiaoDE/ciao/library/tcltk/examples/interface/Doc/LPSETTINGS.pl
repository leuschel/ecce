...
systempath := ~atom_concat( [ ~ciaosrc , '/lib' ] )|
    ...
    ~atom_concat( [ ~ciaosrc , '/library/tcltk/examples/interface' ] ).
% ----------------------------------------------------------------------------
...
% for sublibraries) 
% 
component := 'widget_class_doc' | 'menu_class_doc' | 'canvas_class_doc' | 'button_class_doc' | 'checkbutton_class_doc' | 'radiobutton_class_doc' | 'menubutton_class_doc' | 'label_class_doc' | 'entry_class_doc' | 'menu_class_doc' | 'menu_entry_class_doc' | 'canvas_class_doc' | 'shape_class_doc' | 'arc_class_doc' | 'oval_class_doc' | 'poly_class_doc' | 'line_class_doc' | 'text_class_doc'.
% ----------------------------------------------------------------------------
