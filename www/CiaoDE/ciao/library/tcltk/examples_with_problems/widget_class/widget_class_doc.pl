...
:- module(widget_class,[],[objects,assertions,isomodes,regtypes]).
...
:- pred get_text(-Text) :: atom
        ...
        # "Text who is displayed in the widget.".
%%------------------------------------------------------------------------
...
:- pred set_font(+Font) :: atom
        ...
        # "Indicates the font of the widget's text.".
%%------------------------------------------------------------------------
...
:- pred get_font(-Font) :: atom
        ...
        # "Gets the font of the widget's text.".
%%------------------------------------------------------------------------
...
%%------------------------------------------------------------------------
:- pred set_borderwidth(-BorderWith) :: atom

        # "Indicates the with's border.".
%%------------------------------------------------------------------------
