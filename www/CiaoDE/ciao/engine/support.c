...
/* --------------------------------------------------------------------------- */
/* instance */
static BOOL cinstance_args_aux PROTO((struct worker *w, int arity, TAGGED *pt1, TAGGED *pt2, TAGGED *x1, TAGGED *x2, int *n));
static BOOL cinstance_aux PROTO((struct worker *w, TAGGED x1, TAGGED x2, int *n));

BOOL cinstance_args(Arg,arity,pt1,pt2,n)
     Argdecl;
     REGISTER int arity;
     REGISTER TAGGED *pt1, *pt2;
     int *n;
...
static BOOL cinstance_args_aux(Arg,arity,pt1,pt2,x1,x2,n)
     Argdecl;
     REGISTER int arity;
     REGISTER TAGGED *pt1, *pt2;
     TAGGED *x1, *x2;
...
static BOOL cinstance_aux(Arg,x1,x2,n)
     Argdecl;
     TAGGED x1, x2;
     int *n;
{
  REGISTER TAGGED u, v, t1, nt;
...
/* --------------------------------------------------------------------------- */
/* ground */
static BOOL cground_args_aux PROTO((struct worker *w, int arity, TAGGED *pt1, TAGGED *x1));
static BOOL cground_aux PROTO((struct worker *w, TAGGED x1));

static BOOL cground_args_aux(Arg,arity,pt1,x1)
     Argdecl;
     REGISTER int arity;
     REGISTER TAGGED *pt1;
     TAGGED *x1;
...
static BOOL cground_aux(Arg,x1)
     Argdecl;
     TAGGED x1;
{
  REGISTER TAGGED u, t1;
