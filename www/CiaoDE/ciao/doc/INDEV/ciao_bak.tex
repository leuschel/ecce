...
@c This is the manual for the CIAO system
@c %**start of header
@setfilename ciao
@settitle CIAO
...
@ifinfo
This file documents CIAO.

Copyright @copyright{} 1997, UPM-CLIP.
@end ifinfo
...
@titlepage
@title CIAO User's Manual
@font@authorrm=cmbx10 scaled @magstep2
@author CLIP Group @hfill @email{clip@@dia.fi.upm.es}
@subtitle Universidad Politecnica de Madrid
@subtitle 28660-Boadilla del Monte, MADRID, Spain
@subtitle Draft version: @today

@page
@sp 10
@center @titlefont{CIAO User's Manual}
@sp 2
@center @today
@sp 4
@center This manual is based on the SICStus Prolog 0.5-0.7 User's Manual by
@center Mats Carlsson and Johan Widen

@center Modified for CIAO by
@center Daniel Cabeza
@center CLIP Group
@sp 4
@center This manual corresponds to CIAO version 0.0.
...
CLIP Group @hfill @email{clip@@dia.fi.upm.es}@*
...
CIAO
****
The CIAO system implements an extension of the Prolog language.
...
thus: @kbd{a}, while control characters are written like this: @kbd{^A}.
Thus @kbd{^C} is the character you get by holding down the @key{CTL} key
...
of overriding this : the @kbd{t} option after a @kbd{^C} interrupt will
...
When you end the break (@kbd{^D}) you will be reprompted at the port at
