...
/* Specialised program generated by ECCE 2.0 *//* PD Goal: [what_to_do_today(first_of_may,A,B)] */
...
/* Transformation time: 240.0 ms */
/* Unfolding time: 170.0 ms */
/* Post-Processing time: 10.0 ms */
