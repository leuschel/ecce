:- module('whistle.chconj-termsize',['whistle.chconj-termsize:whistle'/4]).
...
'whistle.chconj-termsize:whistle'(GoalID,Goal,Chtree,WhistlGoalID) :-
...
'whistle.chconj-termsize:find_growing_among_ancestors'(ParID,Goal,Chtree,ParID) :-
...
'whistle.chconj-termsize:find_growing_among_ancestors'(ParID,Goal,Chtree,WhistlGoalID) :-
	...
	'whistle.chconj-termsize:find_growing_among_ancestors'(ParID2,Goal,Chtree,WhistlGoalID).
